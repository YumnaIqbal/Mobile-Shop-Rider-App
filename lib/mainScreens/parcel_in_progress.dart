...
import 'package:mobileshop_rider_app/assistantMethod/assistant_method.dart';
import 'package:mobileshop_rider_app/global/global.dart';
import 'package:mobileshop_rider_app/widgets/order_card.dart';
import 'package:mobileshop_rider_app/widgets/progress_bar.dart';
import 'package:mobileshop_rider_app/widgets/simple_app_bar.dart';
              ...
              itemBuilder: (c, index)
              {
                return FutureBuilder<QuerySnapshot>(
                  future: FirebaseFirestore.instance
                      .collection("models")
                      .where("modelID", whereIn: separateOrdersItemIDs((snapshot.data!.docs[index].data()! as Map<String, dynamic>) ["productIDs"]))
